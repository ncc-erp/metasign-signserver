...
public class PDFSigner extends BaseSigner {
    ...
    /** [MetaSign] Field name to set for visible signature field. */
    public static final String VISIBLE_SIGNATURE_FIELD_NAME = "VISIBLE_SIGNATURE_FIELD_NAME";
    public static final String VISIBLE_SIGNATURE_FIELD_NAME_DEFAULT = null;
    ...
    protected byte[] calculateSignature(final PrivateKey privKey,
                                        ...
                                        final Calendar cal,
                                        final PDFSignerParameters params,
                                        final Certificate[] certChain,
                                        final TSAClient tsc, final byte[] ocsp,
                                        final PdfSignatureAppearance sap,
                                        final String tsaDigestAlgo)
            throws IOException, DocumentException, SignServerException {
            ...
            if (params.isAdd_visible_signature()) {
                try {
                    ...
                    if (params.getVisible_sig_name() != null && !params.getVisible_sig_name().isEmpty()) {
                        ...
                        sap.setVisibleSignature(new com.lowagie.text.Rectangle(params.getVisible_sig_rectangle_llx(), params.getVisible_sig_rectangle_lly(), params.getVisible_sig_rectangle_urx(), params.getVisible_sig_rectangle_ury()), signaturePage, params.getVisible_sig_field_name());
                    }
